...
// public String getNhanViens(@RequestParam(value = "page", defaultValue = "0")
// int page,
...
// public String add(@Valid @ModelAttribute("nhanVien") NhanVienRequest
// nhanVienRequest,
...
// public String update(@PathVariable Integer id,@Valid
// @ModelAttribute("nhanVien") NhanVienRequest nhanVienRequest,
// BindingResult result){
// if (result.hasErrors()){
// return "SuaNhanVien";
// }
...
// public String timNhanVien(Model model, @RequestParam(name = "keyword",
...
//
//// @GetMapping("/quan-ly-nhan-viens/searchNV")
//// public String timNhanVien(@RequestParam(value = "page", defaultValue = "0")
// int page,
//// @RequestParam(value = "size", defaultValue = "5") int size,
...
// nhanVienRepo.timNhanVien(keyword,pageable).getContent());
//// model.addAttribute("currentPage", page);
//// model.addAttribute("pageSize", size);
//// model.addAttribute("totalPages",
// nhanVienRepo.timNhanVien(keyword,pageable).getTotalPages());
//// return "NhanVien";
//// }
// @GetMapping("/quan-ly-nhan-viens/locTrangThaiNV")
// public String locNhanVien(Model model, @RequestParam(name = "trangThai",
// required = false) String trangThai) {
