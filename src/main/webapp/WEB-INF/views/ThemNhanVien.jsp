...
<%--        </div>--%>
<%--    </c:if>--%>
    <form:form action="/quan-ly-nhan-viens/addNV" method="post" modelAttribute="nhanVien">
        <div class="mb-3">
...
=======
            <form:errors path="ma_nhan_vien" cssClass="text-danger"></form:errors>
>>>>>>> 613ae0e0b053357e571a5242af648bb7010cf9a5
        </div>
...
<%--            <form:errors path="so_dien_thoai" cssClass="text-danger"></form:errors>--%>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control"  name="dia_chi_lien_he" required>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" name="roles">
                <c:forEach items="${listRoles}" var="lstR">
                    <option value="${lstR.id_roles}">${lstR.ten_roles}</option>
                </c:forEach>
            </select>
